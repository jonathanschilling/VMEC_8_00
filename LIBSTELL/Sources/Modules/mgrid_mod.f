...
!
      ...
      CHARACTER*(*), INTENT(in) :: mgrid_file
C-----------------------------------------------
C   L o c a l   P a r a m e t e r s
C-----------------------------------------------
c !DEC$ IF DEFINED (VMS)
c       CHARACTER*(*), PARAMETER :: mgrid_defarea = 'vmec$:[makegrid]'
c !DEC$ ELSE
...
C-----------------------------------------------
     ...
     1                       brtemp, bztemp, bptemp
      ...
      CHARACTER*100 :: temp
      CHARACTER*100, ALLOCATABLE, DIMENSION(:) :: vn_br, vn_bp, vn_bz
C-----------------------------------------------
