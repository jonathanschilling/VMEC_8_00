...
!DEC$ ENDIF
      ...
      INTEGER, save :: kount, npossum,ig2sum, istart, istore
      INTEGER, save :: ncross, ipick, mate1, mate2, istat
      INTEGER, save :: i, j
      INTEGER       :: nfev, iflag, max_num_processors, myid
      REAL(rprec), save :: fbar, evals
      REAL(rprec)       :: best
      CHARACTER(len = *) :: filename
      CHARACTER(len = len_trim(filename)+10) :: temp
!     SAVE
c
c     CALL input
c
